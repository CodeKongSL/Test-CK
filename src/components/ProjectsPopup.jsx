    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed inset-0 bg-black/80 backdrop-blur-md z-50 flex items-center justify-center p-4 pt-20 sm:pt-24"
          onClick={onClose}
        >
          <motion.div
            ...
            className="bg-primary/95 backdrop-blur-xl rounded-3xl max-w-6xl w-full max-h-[85vh] sm:max-h-[80vh] overflow-y-auto overflow-x-hidden border border-tertiary/30 shadow-2xl scrollbar-hide"
          ...
          >
            ...
            <div className="mb-6 sm:mb-8">
              ...
              <div className="flex justify-between items-start mb-4 sm:mb-0">
                ...
                <motion.button
                  onClick={onClose}
                  className="text-white hover:text-tertiary transition-colors p-2 hover:bg-white/10 rounded-xl flex-shrink-0"
              ...
              <motion.button 
                ...
                className="bg-tertiary hover:bg-tertiary/80 py-2 px-4 sm:py-3 sm:px-6 rounded-xl text-white font-bold shadow-lg transition-all flex items-center gap-2 sm:gap-3 group text-sm sm:text-base mt-4 sm:mt-0"
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" viewBox="0 0 24 24" className="sm:w-5 sm:h-5 group-hover:rotate-12 transition-transform">
            ...
            >
              {/* Scroll hint */}
              <div className="text-secondary text-sm sm:text-base mb-4 flex items-center gap-2 px-1">
                <span className="font-medium">Scroll horizontally to explore projects</span>
                <motion.div
                  animate={{ x: [0, 10, 0] }}
              ...
              <div className="relative">
                ...
                <div className="absolute top-0 left-0 w-4 sm:w-8 h-full bg-gradient-to-r from-primary/95 to-transparent pointer-events-none" />
                <div className="absolute top-0 right-0 w-4 sm:w-8 h-full bg-gradient-to-l from-primary/95 to-transparent pointer-events-none" />
              </div>
            </motion.div>
            </div>
          </motion.div>
