...
const ReachMe = () => {
  ...
  const contactItems = [
    { icon: icons.email, label: "Email", value: "Thisendissanayake3@gmail.com", link: "mailto:Thisendissanayake3@gmail.com" },
    { icon: icons.phone, label: "Phone", value: "+94 722042191" },
